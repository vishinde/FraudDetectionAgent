# FraudDetectionAgent
Fraud Detection Agent based on ADK and MCP Tool for Databases built on top of AlloyDB and BigQuery demonstrating Federated Queries for BigQuery on AlloyDB
